describe("Payments test (with setup and tear-down", function () {
    ...
    it('should not add a new payment on payment on submitPaymentInfo() with empty input', function () {
        billAmtInput.value = '';
        submitPaymentInfo();
    ...
    it('should payment update #paymentTable on appendPaymentTable()', function () {
        ...
        let curTdList = document.querySelectorAll('#paymentTable tobody tr td');
